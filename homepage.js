...
const sliderImages = [
  ...
  {image: "images/Flagro.jpeg",         logo:"images/FlagroBlackLogo.png"}
];
...
const galleryItems = [
  ...
  { cat: 'graphic',   title: 'Flagro',       artist: 'Sam Lee',      image: "images/mascot.jpeg"   },
];
...
const teamMembers = [
  { name: 'Shrirang',   role: 'Coordinator', image: "images/Jesus.jpeg"},
  { name: 'Saksham',  role: 'Coordinator',     image: "images/Jesus.jpeg"},
  { name: 'Alisha',    role: 'Social Media',    image: "images/Jesus.jpeg"},
  { name: 'Kalyani', role: 'Social Media',    image: "images/Jesus.jpeg" }
];
...
function renderGallery() {
  ...
  <div style="height:270px; display:flex; flex-direction:column;">
    ...
    <!-- BOTTOM: Text -->
    <div style="height:50%; padding:12px; display:flex; flex-direction:column; justify-content:center;">
      <p class="font-heading" style="font-size:16px; font-weight:600;">
        ${item.title}
      </p>
      <p class="font-body text-gray-500" style="font-size:13px;">
        ${item.artist}
      </p>
    </div>
...
function renderTeam() {
  ...
  teamMembers.forEach(m => {
    ...
    card.innerHTML = `
      <div class="blob-card" style="height:200px; margin-bottom:30px;">
            <img src="${m.image}"style="width:100%; height:100%; object-fit:cover; border-radius:16px;" />
      </div>
